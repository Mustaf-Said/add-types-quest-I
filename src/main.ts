...
console.log(`Äldest person i gruppen är ${getOldPerson(arr)}`);
//Byt ut A och B mot funktionsanrop. Ska de två funktionerna
console.log(`Youngst person i gruppen är ${getYoungPerson(arr)}`);
...
/* vi vill ha en pretty print som skriver ut alla färger som hundarna har 
och hur många hundar det finns av varje färg */
